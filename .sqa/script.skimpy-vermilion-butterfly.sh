...
cp ec3_recipe/kubernetes.radl /etc/ec3/templates
ec3 launch sqaaas_ec3_cluster kubernetes nfs-saps saps ubuntu-basic -a "/im/auth.dat" -u https://appsgrycap.i3m.upv.es:31443/im/ -y
